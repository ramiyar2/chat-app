...
Color green_op = const Color.fromRGBO(30, 253, 119, 0.5);
Color dark_green = const Color.fromRGBO(0, 154, 62, 1);
Color dark_blue = const Color.fromRGBO(24, 42, 43, 1);
Color dark_blue_op = const Color.fromRGBO(24, 42, 43, 0.8);
Color darker_blue = const Color.fromRGBO(1, 26, 27, 1);
Color white_op = const Color.fromRGBO(255, 255, 255, 0.5);
